...
<nav class="navbar navbar-inverse">
  ...
  <div class="container-fluid">
    ...
    <?php
        ...
        $sql="SELECT op.op_id,op.op_content,user_info2.name,op.op_date FROM op LEFT JOIN user_info2 ON op.op_author=user_info2.userid WHERE op.op_subject='TA101'";
