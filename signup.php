...
<script type="text/javascript">
   ...
   <h1>Registration page</h1>
     ...
     <img id="uploadPreview" src="default.jpg" class="pic"><br><br>
     &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
	 &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <input type="file" id="imglk" name="imglk" accept=".jpg,.jpeg,.png" onchange="PrevImage();"/><!--to accept image in given format-->
	 <br>
	<center>
    ...
    <a href="signup.php"><input name="submit_btn" type="submit" id="btn1" value="Submit"/></a>
    <a href="login.php"><input type="button" id="btn3" value="Back to Login"></a>
	 </center>
     </form> 
	 <?php
